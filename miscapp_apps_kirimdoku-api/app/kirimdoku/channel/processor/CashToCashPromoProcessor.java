...
public class CashToCashPromoProcessor extends BaseChannelProcessor {
	...
	public Result CashOutInquiry(CashOutInquiryHelper helper) {
		Logger.info("--------------------------------------------------");
		Logger.info(":: PROCESSOR CASH TO CASH PROMO CASHOUT INQUIRY :: ");
		Logger.info("==================================================");
		ObjectNode result = Json.newObject();
		try {
	...
	public Result CashOutValidate(CashOutValidateHelper helper) {
		Logger.info("---------------------------------------------------");
		Logger.info(":: PROCESSOR CASH TO CASH PROMO CASHOUT VALIDATE :: ");
		Logger.info("===================================================");
		ObjectNode result = Json.newObject();
		try {
