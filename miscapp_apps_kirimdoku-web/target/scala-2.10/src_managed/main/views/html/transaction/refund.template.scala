...
import views.html._
/**/
object refund extends BaseScalaTemplate[play.api.templates.Html,Format[play.api.templates.Html]](play.api.templates.HtmlFormat) with play.api.templates.Template1[Form[controllers.Transaction.FilterForm],play.api.templates.Html] {
...
<div class="page-header">
    <h1>"""),_display_(Seq[Any](/*9.10*/doku/*9.14*/.kirimdoku.util.MultiLanguage.getLanguage("LANG012","Refund Transaction"))),format.raw/*9.87*/("""</h1>
</div>
...
<div class="row">
	<div class="well span12">
		"""),_display_(Seq[Any](/*16.4*/helper/*16.10*/.form(action = routes.Transaction.refund, 'class -> "form-horizontal form-transaction-filter", Symbol("data-remote") -> "true")/*16.137*/ {_display_(Seq[Any](format.raw/*16.139*/("""
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/pebri/Documents/play-2.1.1/miscapp_apps_kirimdoku-web/app/views/transaction/refund.scala.html
                    HASH: f179e33de01e1da4bd36554fee08c7fdd79b0103
