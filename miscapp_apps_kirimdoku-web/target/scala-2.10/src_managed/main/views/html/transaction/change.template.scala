...
import views.html._
/**/
object change extends BaseScalaTemplate[play.api.templates.Html,Format[play.api.templates.Html]](play.api.templates.HtmlFormat) with play.api.templates.Template1[Form[controllers.Transaction.FilterForm],play.api.templates.Html] {
...
<div class="page-header">
    <h1>"""),_display_(Seq[Any](/*9.10*/doku/*9.14*/.kirimdoku.util.MultiLanguage.getLanguage("LANG013","Change Transaction"))),format.raw/*9.87*/("""</h1>
</div>
...
<div class="row">
	<div class="well span12">
		"""),_display_(Seq[Any](/*16.4*/helper/*16.10*/.form(action = routes.Transaction.change, 'class -> "form-horizontal form-transaction-filter", Symbol("data-remote") -> "true")/*16.137*/ {_display_(Seq[Any](format.raw/*16.139*/("""
...
<script type="text/javascript" src='"""),_display_(Seq[Any](/*42.38*/routes/*42.44*/.Assets.at("javascripts/send.js"))),format.raw/*42.77*/("""'></script>
""")))})),format.raw/*43.2*/("""
"""))}
    }
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/pebri/Documents/play-2.1.1/miscapp_apps_kirimdoku-web/app/views/transaction/change.scala.html
                    HASH: 15e2e2bee8aff517606d0a983f495dbdd6246e7d
                    MATRIX: 770->1|951->55|978->107|1015->110|1054->141|1092->142|1164->179|1176->183|1270->256|1320->271|1335->278|1371->292|1456->342|1471->348|1608->475|1649->477|1689->482|1704->488|2008->784|2075->813|2181->883|2205->885|2250->894|2276->898|2322->908|2349->913|2388->916|2426->932|2527->996|2541->1000|2624->1060|2679->1084|2714->1088|2863->1219|2902->1221|2984->1267|2999->1273|3062->1314|3138->1354|3153->1360|3215->1400|3300->1449|3315->1455|3370->1488|3414->1501
                    LINES: 26->1|32->1|33->4|35->6|35->6|35->6|38->9|38->9|38->9|41->12|41->12|41->12|45->16|45->16|45->16|45->16|46->17|46->17|52->23|52->23|54->25|54->25|54->25|54->25|54->25|54->25|54->25|54->25|54->25|54->25|54->25|56->27|57->28|68->39|68->39|69->40|69->40|69->40|70->41|70->41|70->41|71->42|71->42|71->42|72->43
                    -- GENERATED --
                */
