...
public class CashToCashProcessor extends BaseChannelProcessor {
	...
	public Result CashInInquiry(CashInInquiryHelper helper) {
		Logger.info("-------------------------------------------");
		Logger.info(":: PROCESSOR CASH TO CASH CASHIN INQUIRY :: ");
		Logger.info("===========================================");
	...
	public Result CashInRemit(CashInRemitHelper helper) {
		Logger.info("-----------------------------------------");
		Logger.info(":: PROCESSOR CASH TO CASH CASHIN REMIT :: ");
		Logger.info("=========================================");
		...
		try {
			...
			// save transaction
			Logger.info("Attempting to save remit to db..");
			trx.save();
			...
			remit.put("transactionId", TransactionToken.fromTransaction(trx)
					.toString());
	...
	public Result CashOutInquiry(CashOutInquiryHelper helper) {
		Logger.info("--------------------------------------------");
		Logger.info(":: PROCESSOR CASH TO CASH CASHOUT INQUIRY :: ");
		Logger.info("============================================");
		ObjectNode result = Json.newObject();
		try {
	...
	public Result CashOutValidate(CashOutValidateHelper helper) {
		Logger.info("---------------------------------------------");
		Logger.info(":: PROCESSOR CASH TO CASH CASHOUT VALIDATE :: ");
		Logger.info("=============================================");
		ObjectNode result = Json.newObject();
		try {
	...
	public Result CashOutCollect(CashOutCollectHelper helper) {
		Logger.info("--------------------------------------------");
		Logger.info(":: PROCESSOR CASH TO CASH CASHOUT COLLECT :: ");
		Logger.info("============================================");
		ObjectNode result = Json.newObject();
